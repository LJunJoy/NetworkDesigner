...
namespace WeifenLuo.WinFormsUI.Docking
{
    ...
    public class VS2012LightTheme : ThemeBase
    {
        ...
        public static DockPanelSkin CreateVisualStudio2012Light()
        {
            ...
            skin.DockPaneStripSkin.ToolWindowGradient.InactiveTabGradient.TextColor = Color.Black;//SystemColors.GrayText; //lcj
            ...
            skin.DockPaneStripSkin.ToolWindowGradient.InactiveCaptionGradient.TextColor = Color.Black;//SystemColors.GrayText; //lcj
